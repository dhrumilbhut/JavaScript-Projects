...
```
document.querySelector(".side-bar .crayons-subtitle-2 ").innerText = "iNeuron"
document.querySelector(".side-bar .crayons-card p ").innerText = "I Write Code"
```
...
```
const table = document.querySelector(".accordion-homepage")
...
```
document.querySelector(".customer-support .service-number").innerText = "+91 1234567890"
```
...
```
const items = document.querySelectorAll("#SIvCob a")
...
```
document.querySelector(".container .content-width-extra-large h1").style.fontFamily = "monospace"
document.querySelector(".container .content-width-extra-large h1").style.color = "red"
```
...
```
const item = document.querySelector(".signup-btn .login-btn-text")
...
```
document.querySelector(".ps-top .ps-title").style.textAlign = "center";
```
...
```
document.querySelector(".section-title_title__VEDfK").innerText = "Start from Strach"
```
